...
A `CITATION.cff` file is recommended. GitHub will use this file to display a **Cite this repository** button.

Suggested citation language:

```text
If you use this workflow in a publication, report, thesis, dissertation,
software package, or derivative workflow, please cite this repository and
the original BFAST methodology.
```
...
- AGPL-3.0 promotes open redistribution of derivative works.
- AGPL-3.0 does not prohibit all commercial use.
- Open-source licenses generally cannot require formal academic citation.
- Citation should be requested through `CITATION.cff`, README instructions, and publication norms.
