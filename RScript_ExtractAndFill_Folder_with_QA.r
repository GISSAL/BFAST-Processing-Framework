#--------------------------------------------------------------------------------------
# Name:         RScript_ExtractAndFill_Folder.R
...
output_dir <- "D:/Research/Projects/BFAST_2001_2025/BFAST_H0.15/filled"
...
extract_values_for_tile <- function(tile,
  ...
  output_file <- file.path(output_dir, paste0(shp_name, raw_output_suffix))
...
fill_na_for_tile <- function(tile,
  ...
  shp_name <- paste0(shape_prefix, tile)
  output_file <- file.path(output_dir, paste0(shp_name, fill_output_suffix))
